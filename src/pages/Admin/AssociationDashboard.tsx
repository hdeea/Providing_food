...
import { BondsIssuance, HelpRequest, DonationIndividualDto } from '../../types/individual';
...
const AssociationDashboard: React.FC = () => {
  ...
  const [vouchers, setVouchers] = useState<BondsIssuance[]>([]);
...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6">
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-emerald-600 uppercase tracking-wide dark:text-emerald-400">الطلبات المقبولة</p>
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-amber-600 uppercase tracking-wide dark:text-amber-400">الطلبات المعلقة</p>
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-rose-600 uppercase tracking-wide dark:text-rose-400">طلبات المطاعم</p>
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-blue-600 uppercase tracking-wide dark:text-blue-400">طلبات المساعدة</p>
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-rose-600 uppercase tracking-wide dark:text-rose-400">التبرعات</p>
        <p className="text-4xl font-black text-slate-900 mt-2 dark:text-slate-100">{donors.length}</p>
        <p className="text-xs text-slate-500 mt-1 dark:text-slate-400">تبرعات الأفراد</p>
      </div>
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-rose-100 ring-1 ring-rose-200/80 dark:bg-rose-800 dark:ring-rose-500/30">
  ...
  >
    <div className="flex items-center justify-between gap-4">
      <div>
        <p className="text-sm font-semibold text-amber-600 uppercase tracking-wide dark:text-amber-400">بانتظار المراجعة</p>
        <p className="text-4xl font-black text-slate-900 mt-2 dark:text-slate-100">
          {[...helpRequests, ...donors].filter(r => r.status === 'pending').length}
        </p>
        <p className="text-xs text-slate-500 mt-1 dark:text-slate-400">طلبات تحتاج قرارك</p>
      </div>
      <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-amber-100 ring-1 ring-amber-200/80 dark:bg-amber-800 dark:ring-amber-500/30">
  ...
  <TabsTrigger value="restaurants" className="flex items-center gap-2 rounded-xl data-[state=active]:bg-white data-[state=active]:text-rose-700 data-[state=active]:shadow-md transition dark:data-[state=active]:bg-slate-600 dark:data-[state=active]:text-rose-300">
    🍽️ المطاعم ({pendingRestaurants.length})
  </TabsTrigger>
  ...
  <TabsTrigger value="vouchers" className="flex items-center gap-2 rounded-xl data-[state=active]:bg-white data-[state=active]:text-emerald-700 data-[state=active]:shadow-md transition dark:data-[state=active]:bg-slate-600 dark:data-[state=active]:text-emerald-300">
    <Ticket className="w-4 h-4" /> القسائم
  </TabsTrigger>
